"""Eagle model loading and input preparation."""
import torch
...
def load_eagle_model(device: str, model_id: str | None = None):
    ...
    Notes:
        Available variants include nvidia/Eagle2.5-8B, nvidia/Eagle2-1B,
        nvidia/Eagle2-2B, and nvidia/Eagle2-9B.
    """
...
def get_eagle_inputs(
    ...
    """Prepare inputs for the Eagle2.5 model."""
