"""LLaVA-ST model loading and input preparation."""
import copy
import os
import sys
...
def _ensure_llava_st_import_path() -> None:
    """Internal helper for ensure llava st import path."""
...
def _get_llava_st_root() -> Path:
    """Internal helper for get llava st root."""
...
@contextmanager
def _llava_st_cwd():
    """Internal helper for llava st cwd."""
    prev_cwd = os.getcwd()
    llava_st_root = _get_llava_st_root()
