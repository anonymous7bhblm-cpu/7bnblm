"""InternVL model loading and input preparation."""
import numpy as np
...
def load_intern3_model(device: str, model_id: str | None = None):
    """Load an InternVL3 multimodal model.

    Notes:
        Available variants include OpenGVLab/InternVL3-1B, OpenGVLab/InternVL3-2B,
        OpenGVLab/InternVL3-8B, OpenGVLab/InternVL3-9B, OpenGVLab/InternVL3-14B,
        OpenGVLab/InternVL3-38B, OpenGVLab/InternVL3-78B,
        OpenGVLab/InternVL3_5-8B, OpenGVLab/InternVL3_5-14B,
        OpenGVLab/InternVL3_5-30B-A3B, OpenGVLab/InternVL3_5-38B, and
        OpenGVLab/InternVL3_5-241B-A28B. These are final checkpoint variants
        without suffixes.
    """
...
def get_intern3_inputs(
    ...
    """Prepare inputs for InternVL3 models."""
