...
class SpatioTemporalEvaluator:
    ...
    def _assert_csv(self, file: str) -> None:
        """Internal helper for assert csv."""
    ...
    def load_pred_tubes(self, file: str) -> dict[str, Tube]:  # noqa: D102
        """Load predicted tubes from a CSV file."""
        self._assert_csv(file)
    ...
    def _evaluate_single(
        ...
        """Internal helper for evaluate single."""
        """Load gt tubes."""
        """Load pred tubes."""
        """Load query info."""
        """Load video info."""
...
def _summarize_single_df(
    ...
    """Internal helper for summarize single df."""
...
def summarize_and_save_eval_simple(  # noqa: D103
    ...
    """Summarize and save eval simple."""
